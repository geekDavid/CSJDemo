...
import com.hihonor.ads.adgroupdemo.dialog.DislikeDialog;
import com.hihonor.ads.adgroupdemo.utils.TToast;
...
public class MainActivity extends Activity {
    ...
    private void initData() {
        ...
        mBannerAdSizeModelList.add(new AdSizeModel("600*90", 300, 45, "951934207"));
    ...
    public static class AdapterForBannerType extends RecyclerView.Adapter<AdapterForBannerType.ViewHolder> {
        ...
        public AdapterForBannerType(MainActivity activity, List<AdSizeModel> bannerSize) {
